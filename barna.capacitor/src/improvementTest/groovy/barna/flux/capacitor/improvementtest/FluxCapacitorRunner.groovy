...
class FluxCapacitorRunner {
    ...
    private static File prepareTestData() {
        ...
        def fileName = "test_data_imp-1.0.tgz"

        def targetFile = new File(targetDirectory, fileName)
        File test_data_dir = new File(targetDirectory, "test_data_imp")
        ...
        /*if (invalid_file) {
            ...
            if (test_data_dir.exists()) {
                FileHelper.rmDir(new File(targetDirectory, "test_data_imp"))
            }
            if (md5File.exists()) {
                md5File.delete()
            }
        ...
        if (!test_data_dir.exists()) {
            ...
            untar(targetFile, targetDirectory)
        }
