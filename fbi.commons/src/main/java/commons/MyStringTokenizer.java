 ...
 * @since   JDK1.0
 */
public class MyStringTokenizer implements Enumeration<Object> {
	     ...
	     */
	    public MyStringTokenizer(CharSequence str, String delim, boolean returnDelims) {
		currentPosition = 0;
		newPosition = -1;
		delimsChanged = false;
		this.str = str;
	     ...
	     * @exception NullPointerException if str is <CODE>null</CODE>
	     */
	    public MyStringTokenizer(CharSequence str, String delim) {
	     ...
	     * @exception NullPointerException if str is <CODE>null</CODE> 
	     */
	    public MyStringTokenizer(CharSequence str) {
		this(str, " \t\n\r\f", false);
	    }
	     ...
	     */
	    public CharSequence nextToken(String delim) {
		delimiters = delim;
