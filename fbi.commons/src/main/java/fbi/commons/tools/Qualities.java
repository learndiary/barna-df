...
public class Qualities {
    ...
    public static int quality(Technology tech, char value){
        switch (tech){
            case Phred: return (value - PHRED_RANGE_ASCII[0]);
            case Illumina13: return (value - ILLUMINA_13_RANGE_ASCII[0]);
            case Illumina18: return (value - ILLUMINA_13_RANGE_ASCII[0]);
            case Solexa: return solexa2phredQuality((value - SOLEXA_RANGE_ASCII[0]));
        }
        return -1;
    }
